...
void draw() {
  ...
  /*          noStroke()        hand in hand with rect()
  ...
  rect(0, 0, width, height-height*0.065);// rect(a, b, c, d): a=x-coord, b=y-coord, c=width, d=height 
...
void serialEvent (Serial myPort) { // starts reading data from the Serial Port
  ...
  data = data.substring(0,data.length()-1);/*  str.substring(beginIndex)    str.substring(beginIndex, endIndex)  */
